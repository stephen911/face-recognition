...
course = 'business' 
create_table_sql = f"CREATE TABLE IF NOT EXISTS {table_name} (name TEXT, id TEXT, course TEXT, time TEXT, date DATE, UNIQUE(name, course, date))"
...
class Face_Recognizer:
    ...
    def attendance(self, name):
        ...
        cursor.execute("SELECT * FROM attendance WHERE name = ? AND date = ? AND course = ?", (name, current_date, self.course))
        ...
        if existing_entry:
            ...
            cursor.execute("INSERT INTO attendance (name, id, course, time, date) VALUES (?, ?, ?, ?, ?)", (name, id, self.course, current_time, current_date))
            conn.commit()
